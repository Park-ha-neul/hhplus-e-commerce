...
public class UserPointService {
    ...
    public void charge(Long userId, Long amount) {
        try{
            ...
            throw new IllegalArgumentException(UserPointErrorCode.CONCURRENCY_CHARGE_POINT.getMessage());
        }
    }
    ...
    public void use(Long userId, Long amount) {
        try{
            ...
            throw new IllegalArgumentException(UserPointErrorCode.CONCURRENCY_USE_POINT.getMessage());
        }
    }
